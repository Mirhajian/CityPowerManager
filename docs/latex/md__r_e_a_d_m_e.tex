...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_نحوه-کامپایل-گیری}{}\doxysection{\texorpdfstring{نحوه کامپایل گیری}{نحوه کامپایل گیری}}\label{md__r_e_a_d_m_e_نحوه-کامپایل-گیری}

\begin{DoxyItemize}
\item با اینکه از پیش این پروژه کامپایل گرفته شده و فایل اجرایی ویندوز آن موجود است، در صورت تمایل میتوانید از این روش استفاده کنید\+: 
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_پیش-نیاز-ها}{}\doxysubsection{\texorpdfstring{پیش نیاز ها}{پیش نیاز ها}}\label{md__r_e_a_d_m_e_پیش-نیاز-ها}
